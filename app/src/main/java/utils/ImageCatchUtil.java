...
public class ImageCatchUtil {
    ...
    private final String ImageExternalCatchDir ="/data/data/xiangcuntiandi.quanmather/cache/image_manager_disk_cache";
    ...
    public  String getCacheSize(Context context) {
        try {
            return getFormatSize(getFolderSize(new File(Glide.getPhotoCacheDir(context).getAbsolutePath())));
        } catch (Exception e) {
            e.printStackTrace();
        }
        return "";
