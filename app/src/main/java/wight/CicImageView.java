...
public class CicImageView extends ImageView {
	...
	public CicImageView(Context context) {
		super(context);
	}

	public CicImageView(Context context, AttributeSet attrs) {
		this(context, attrs, 0);
	}

	public CicImageView(Context context, AttributeSet attrs, int defStyle) {
