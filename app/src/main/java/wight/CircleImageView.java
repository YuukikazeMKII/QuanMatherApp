...
//			 imageView.setScaleType(ImageView.ScaleType.CENTER_INSIDE);
			...
			// }
			// imageLoader = ToolImage.initImageLoader(mContext);
			MyApp.getInstance().getImageLoader().displayImage(
					imageUrl,
					imageView,
					MyApp.getInstance().getFadeOptions(R.drawable.icon,
	...
	public void setOnCheckedChanged(ImageCycleViewListener listener) {
