...
public class FuLiRecAdter extends RecyclerView.Adapter<FuLiRecAdter.MyViewHolder> {

    private final Context context;


    private List<FuLiBean.DataBean.RowsBean.ItemsBean> dataList;

    public FuLiRecAdter(Context context) {
        this.context = context;
    }

    @Override
    public FuLiRecAdter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        FuLiRecAdter.MyViewHolder myViewHolder = new FuLiRecAdter.MyViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.zuihuasuan_item, parent, false));
        return myViewHolder;
    }

    @Override
    public void onBindViewHolder(MyViewHolder holder, final int position) {
        FuLiBean.DataBean.RowsBean.ItemsBean itemsBean = dataList.get(position);
    ...
    public void setData(List<FuLiBean.DataBean.RowsBean.ItemsBean> dataList) {
