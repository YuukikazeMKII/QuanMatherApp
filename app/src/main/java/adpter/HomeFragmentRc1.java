...
public class HomeFragmentRc1 extends RecyclerView.Adapter<HomeFragmentRc1.VH> {


    private final List<HomeBean.DataBean.Section1Bean> list;
    private final Context context;
   public HomeFragmentRc1(Context context, List<HomeBean.DataBean.Section1Bean>list){
    ...
    public void onBindViewHolder(VH holder, int position) {
        final HomeBean.DataBean.Section1Bean section1Bean = list.get(position);
