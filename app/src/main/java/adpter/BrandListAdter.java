...
public class BrandListAdter extends SuperBaseAdapter<ZuiYouHuiBean.DataBean.RowsBean> {
Context context;
    public BrandListAdter(Context context, List<ZuiYouHuiBean.DataBean.RowsBean> data) {
        super(context, data);
