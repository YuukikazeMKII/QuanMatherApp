...
public class FuLiAdpter extends SuperBaseAdapter<ZuiYouHuiBean.DataBean.RowsBean> {
   Context context;
    public FuLiAdpter(Context context, List<ZuiYouHuiBean.DataBean.RowsBean> data) {
        super(context, data);
