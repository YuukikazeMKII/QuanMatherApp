...
public class ZuiHuaSuanadpter1 extends SuperBaseAdapter<ZuiYouHuiBean.DataBean.RowsBean> {
                 Context context;
    public ZuiHuaSuanadpter1(Context context, List<ZuiYouHuiBean.DataBean.RowsBean> data) {
        super(context, data);
 ...
 */
     ...
     */
    @Override
    protected int getItemViewLayoutId(int position, ZuiYouHuiBean.DataBean.RowsBean item) {
